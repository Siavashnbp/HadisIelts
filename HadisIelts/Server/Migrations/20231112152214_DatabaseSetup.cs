        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresEmailResponse = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubmittedServiceId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastUpdateDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsPaymentApproved = table.Column<bool>(type: "bit", nullable: false),
                    IsPaymentCheckPending = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WritingCorrectionSubmissionGroupId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CorrectorId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CorrectedWritingFiles_WritingCorrectionSubmissionGroups_WritingCorrectionSubmissionGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WritingCorrectionFiles_WritingCorrectionSubmissionGroups_WritingCorrectionSubmissionGroupId",
                        column: x => x.WritingCorrectionSubmissionGroupId,
                        principalTable: "WritingCorrectionSubmissionGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVerificationPending = table.Column<bool>(type: "bit", nullable: false),
                    Message = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UploadDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, "Writing Correction" });
